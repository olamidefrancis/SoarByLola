...
const Footer = () => {
  return (
    ...
    //   </div>
    // </footer>
    <footer id="frame-footer" class="grid gap-5 bg-rebrand-accent-100 pb-5 lg:px-5 lg:pb-6 lg:pt-16">
        <nav class="mx-auto hidden grid-flow-col grid-cols-[repeat(auto-fit,minmax(max-content,1fr))] gap-x-16 lg:grid">
            <section>
            ...
            <section>
                        <h2 class="mb-2.5 font-rebrand-light text-sm uppercase text-rebrand-accent-100-contrast">About Us</h2>
                        <ul class="grid list-none gap-3 p-0">
                            <li class="max-w-36"><a href="/about" id="11" class="font-rebrand-light text-xs capitalize text-rebrand-base-400 hover:underline">About Us</a></li>
                            <li class="max-w-36"><a href="/diversity" id="13" class="font-rebrand-light text-xs capitalize text-rebrand-base-400 hover:underline">Diversity</a></li>
                            <li class="max-w-36"><a href="/students" id="15" class="font-rebrand-light text-xs capitalize text-rebrand-base-400 hover:underline">Students &amp; Graduates</a></li>
                            <li class="max-w-36"><a href="/essential-workers-discount" id="16" class="font-rebrand-light text-xs capitalize text-rebrand-base-400 hover:underline">Essential Workers Discount</a></li>
                            <li class="max-w-36"><a href="https://www.debenhamsgroup.com/sustainability/company-policies/#modern-slavery-statements. " id="19" class="font-rebrand-light text-xs capitalize text-rebrand-base-400 hover:underline">Modern Slavery Statement</a></li>
                        </ul>
            </section>

            <section>
                        <h2 class="mb-2.5 font-rebrand-light text-sm uppercase text-rebrand-accent-100-contrast">Information</h2>
                        <ul class="grid list-none gap-3 p-0">
                            <li class="max-w-36"><a href="/terms" id="21" class="font-rebrand-light text-xs capitalize text-rebrand-base-400 hover:underline">Terms &amp; Conditions</a></li>
                            <li class="max-w-36"><a href="/privacy-policy" id="22" class="font-rebrand-light text-xs capitalize text-rebrand-base-400 hover:underline">Privacy Policy</a></li>
                            <li class="max-w-36"><a href="/site-map" id="23" class="font-rebrand-light text-xs capitalize text-rebrand-base-400 hover:underline">Sitemap</a></li>
                            <li class="max-w-36"><a href="/plt-app-info" id="311" class="font-rebrand-light text-xs capitalize text-rebrand-base-400 hover:underline">App Info</a></li>
                        </ul>
            </section>

            <section>
                        <h2 class="mb-2.5 font-rebrand-light text-sm uppercase text-rebrand-accent-100-contrast">My Account</h2>
                        <ul class="grid list-none gap-3 p-0">
                            <li class="max-w-36"><a href="/customer/order-history" rel="nofollow" id="25" class="font-rebrand-light text-xs capitalize text-rebrand-base-400 hover:underline">Order History</a></li><li class="max-w-36"><a href="/faq" id="26" class="font-rebrand-light text-xs capitalize text-rebrand-base-400 hover:underline">Track My Order</a></li><li class="max-w-36"><a href="/refer-a-friend" id="28" class="font-rebrand-light text-xs capitalize text-rebrand-base-400 hover:underline">Refer A Friend</a></li><li class="max-w-36"><a href="/cookies" id="382" class="font-rebrand-light text-xs capitalize text-rebrand-base-400 hover:underline">Cookies</a></li>
                        </ul>
            </section>

            <section>
                <h2 class="mb-2.5 font-rebrand-light text-sm uppercase text-rebrand-accent-100-contrast">Social</h2>
                <ul class="grid list-none gap-3 p-0">
                    <li class="max-w-36"><a href="https://instagram.com/prettylittlething" id="312" class="font-rebrand-light text-xs capitalize text-rebrand-base-400 hover:underline">Instagram</a></li><li class="max-w-36"><a href="https://facebook.com/OfficialPLT" id="313" class="font-rebrand-light text-xs capitalize text-rebrand-base-400 hover:underline">Facebook</a></li><li class="max-w-36"><a href="https://twitter.com/OfficialPLT" id="314" class="font-rebrand-light text-xs capitalize text-rebrand-base-400 hover:underline">X</a></li><li class="max-w-36"><a href="https://tiktok.com/share/user/6590702127344386054" id="315" class="font-rebrand-light text-xs capitalize text-rebrand-base-400 hover:underline">TikTok</a></li><li class="max-w-36"><a href="https://youtube.com/user/prettylittlethingtv" id="316" class="font-rebrand-light text-xs capitalize text-rebrand-base-400 hover:underline">Youtube</a></li>
                </ul>
            </section>
        </nav>
    </footer>
